...
if (isset($_POST['monto'])){
    ...
    if ($monto > 300 && $monto < 500) {
        // Descuento del 42%
        echo "El monto total a pagar con descuento es: " . ($monto - ($monto * 0.42));
    } elseif ($monto > 80 && $monto < 200) {
        // Descuento del 25%
        echo "El monto total a pagar con descuento es: " . ($monto - ($monto * 0.25));
    } elseif ($monto > 30 && $monto <= 79) {
        // Descuento del 10%
        echo "El monto total a pagar con descuento es: " . ($monto - ($monto * 0.10));
    } else {
